        ...
        <div className={style.toolbarHeader}>
            <div className={style.toolbar}>
                <div className={style.toolbarContainer}>
                    <div className={style.toolbarButtonImgIcon} onClick={onClickZoomOut10}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={onClickZoomIn10}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={onClickZoom100}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={onClickFitToWidth}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={onClickFitToHeight}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={onClickFitToPage}>
                        <Image 
                ...
                <div className={style.toolbarContainer}>
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={onClickExportPdf}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={() => onClickExportImg('png')}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={() => onClickExportImg('jpeg')}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={() => onClickExportImg('tif')}>
                        <Image 
                    ...
                    <div className={style.toolbarButtonImgIcon} onClick={() => onClickExportImg('tiff')}>
                        <Image 
