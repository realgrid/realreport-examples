...
.rr-bind-marker {
    ...
    top: -1px;
    right: -1px;
    background: url("./bind-marker.png") no-repeat center/contain;
}
.rr-bind-marker[data-sys] {
    background: url("./bind-marker-sys.png") no-repeat center/contain;
}
...
.rr-focus-handle[data-disabled='true'] {
    cursor: inherit;
...
.rr-check-check[data-checked='0'] {
    background-image: url("./check-unchecked.png");
}
...
.rr-section-head:hover {
    color: #555;
    border-color: #999;
    /* filter: drop-shadow(1px 1px 1px #555555); */
}
.rr-section-head[data-selected] {
    /* color: #555;
    border-color: #999; */
    color: white;
